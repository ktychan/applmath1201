...
One of the simplest differential equation is \(u'(t) = ku(t)\) where \(k\) is a constant. 

\begin{method}
  The general solution to the differential equation (without an initial condition) \(u'(t) = k u\) where \(k\) is the proportionality constant is \(u(t) = C e^{kt}\) where \(C\) is some constant. 
