...
We group differential equations by certain characteristics of the unknown function.
...
\begin{definition}[linear, first-order]
  Assume \(u\) is a function of \(t\). A \hlmain{linear, first-order} differential equation \hlwarn{Edited: ``equations'' \(\to\) ``equation''} is a differential equation of the form
  \[
