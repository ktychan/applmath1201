...
numpy.power(a, 5)  # calculate the fifth power of a.
  ...
  \item To define a function, we use the \pythoninline{def} and \pythoninline{def} syntax.
...
a[-1]   # the last element in the array.
  ...
  \item The list of numbers \(a_{0}, \ldots, a_{6}\) above follows a clear pattern, namely, 
    ...
    We use a for-loop and the \pythoninline{range} to perform this calculation.
