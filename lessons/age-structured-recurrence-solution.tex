...
With the ability to find eigenvectors with their corresponding eigenvalues, we can now solve systems of recurrence equations and get a better answer \hlwarn{Edited: ``get better answer'' \(\to\) ``get a better answer''} than \(\vec{x}(t) = A^{t} \vec{x}(0)\).
...
\begin{method} \label{method:recurrences-system}
  ...
  \begin{enumerate}
    ...
    \item Apply Equation \eqref{eq:solutions-for-recurrence-systems}.
  \end{enumerate}
\end{method}
