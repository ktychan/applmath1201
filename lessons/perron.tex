...
\begin{example}
  Let \(A = \begin{bmatrix} 0 & 1 \\ 1 & 1/2 \end{bmatrix}\) and \(\vec{u}(0) = \begin{bmatrix} 43278 \\ - 743892\end{bmatrix}\).  Describe the long-term behaviour for \(\vec{u}(t + 1) = A \vec{u}(t)\), i.e., describe \(\lim_{t \to \infty} A^{t} \vec{u}(0)\) as a ratio.
...
\begin{exercise}
  The matrix \(A = \begin{bmatrix} 1/3 & 1/2 \\ 1 & 0 \end{bmatrix}\) describes a population dynamics model \(\vec{x}(t+1) = A \vec{x}(t)\) with \(x_{1}(t)\) being adults and \(x_{2}(t)\) being juveniles.  Describe the long-term behaviour for the population as a ratio between adults and juveniles.
