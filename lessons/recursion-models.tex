...
\begin{example} \label{ex:recurrsion-investment-model}
  We deposit \(1000\) dollars into a savings account. At the end of every year since the initial deposit, interest of \(6\%\) of the current balance is paid. We would like to withdraw \(50\) dollars \emph{after} each interest payment.
...
Given a recursive discrete-time model, we can find explanations for the recurrence.
