...
\begin{exercise}
  A local health agency tested \(2000\) birds for a strain of avian flu.  The specificity of the test is \(20\%\) and sensitivity \(95\%\).  The number of birds later confirmed not carrying the avian flu is \(1500\). The other birds had the avian flue.
