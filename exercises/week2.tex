  ...
  \begin{enumerate}
    ...
    \item \(w_{t} = 3\sqrt{w_{t - 1}w_{t - 2} - 1}\).
      \begin{solution}
        ...
        \begin{center}
          \fbox{\includegraphics[width=5in]{./AI_mistake_week2_3.2.png}}
        \end{center}
  ...
  \begin{enumerate}
    \item \(v_{0} = 1\) and \(v_{t} = \frac{1}{3} v_{t-1} + \frac{1}{4}\).
      \begin{solution}
        ...
        \begin{itemize}
          \item If you straight up use the formula, then \(v_{t} = \left(1 - \frac{3}{2}\right) \left( \frac{1}{3} \right)^{t} + \frac{3}{2}\). It is prudent to check that \(v_{t}\) is indeed a solution.  The quick sanity check is to verify the value of \(v_{0}\) against the given.
          ...
          \item If you substitute \(v_{t} = u_{t} + \hat{p}\), then \(u_{t} = v_{t} - \hat{p}\). Once again, be careful with the signs. A little sign goof here will lead to getting stuck at the next step (if you go through all the little algebra steps) or a wrong final answer (if you skip the algebra steps). That also means, if you are stuck at the next step, then look for a sign goof. 
            ...
            \[
              u_{0} = v_{0} - \hat{p} = \left(1 - \frac{2}{3}\right), \quad\text{and}\quad u_{t} = \frac{1}{3} u_{t-1}.
            \]
            Solve this recurrence to get \(u_{t} =\left(1 - \frac{2}{3}\right) \left(\frac{1}{3}\right)^{t}\). Put back \(v_{t}\) to get \(v_{t} = \left(1 - \frac{3}{2}\right) \left( \frac{1}{3} \right)^{t} + \frac{3}{2}\). It's the same solution as above. Once again, it is prudent to check that \(v_{t}\) is indeed a solution.  The quick sanity check is to verify the value of \(v_{0}\) against the given.
        \end{itemize}
      \end{solution}
