...
\section{Week 6 practice problems}
...
\begin{exercise}
  ...
  \begin{solution}
    ...
    \hlwarn{Correction: two denominators are missing a zero. The true-positive rate is \(920/1000\) (out of the \(1000\) sick), and the true-negative rate is \(8550/9000\) (out of the \(9000\) not sick).}
  \end{solution}
\end{exercise}
